...
def crearRecurso():
    ...
    try:
        ...
        if DB.verificacionTipo(body.get('tipo')):
            return {'msg': 'Tipo de recurso no admitido'}, 400
        # ---------------

        DB.addRecurso(body['id'], body['nombre'], body['abreviatura'], body['metrica'], body['tipo'], body['valorXhora'])
